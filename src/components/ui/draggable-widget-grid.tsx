 ...
 *
 * Adapté pour FounderOS : import depuis `framer-motion` (déjà installé — c'est
 * le même moteur que le paquet `motion`, sous son ancien nom), et libellés
 * d'accessibilité en français. Le reste est repris tel quel.
 */
			...
			<div
				...
				{editable && (
					<p id={hintId} className="sr-only">
						Faites glisser pour réorganiser. Sur écran tactile, appuyez
						longuement d'abord. Au clavier, maintenez Alt et utilisez les
						flèches.
					</p>
				)}
				<div
