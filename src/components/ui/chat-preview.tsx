...
// Ported from the shadcn "chat-preview" component for this Vite/React app
// (originally Next.js). Two changes vs. the source:
//   • next/image → a plain <img> (this project isn't Next.js).
//   • NodeJS.Timeout → ReturnType<typeof setInterval> (browser timer type).
// It's an auto-cycling, channel-styled chat feed — great for previews/heroes.
// A live, real-data variant of this look powers the agent CollaborationTab.
