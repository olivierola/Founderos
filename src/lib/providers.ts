...
export const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    ...
    category: "hr",
    icon: UserCheck,
    description: "ATS — import candidates and opportunities into your hiring pipeline.",
    mvp: true,
    fields: [apiKeyField("API key", "…", "https://hire.lever.co/developer/documentation")],
  },
  {
    slug: "workable",
    name: "Workable",
    category: "hr",
    icon: UserCheck,
    description: "Recruiting platform — sync jobs and candidates as application sources.",
    mvp: true,
    fields: [
      { key: "subdomain", label: "Account subdomain", placeholder: "acme (from acme.workable.com)", secret: false },
      apiKeyField("API token", "…", "https://workable.readme.io/"),
    ],
  },
  {
    slug: "linkedin-talent",
    name: "LinkedIn Talent",
    category: "hr",
    icon: Linkedin,
    description: "LinkedIn job applications as a candidate source (via your access token).",
    mvp: true,
    fields: [{ key: "access_token", label: "Access token", placeholder: "…", secret: true, helpUrl: "https://learn.microsoft.com/linkedin/talent/" }],
  },
  {
    slug: "deel",
    name: "Deel",
