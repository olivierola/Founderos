...
export function OpsOverviewPage() {
  ...
  // Unified deployments — external sync + Anduran-driven. This makes the
      ...
      <Card>
        <CardContent className="p-4">
          <div className="mb-3 flex items-center justify-between">
            ...
            <span className="text-[10px] text-muted-foreground">Unified · external syncs + Anduran-driven</span>
          </div>
