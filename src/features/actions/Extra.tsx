...
import { Mail, Send, Loader2, Webhook, Plus, Trash2, Users, Eye, Search } from "lucide-react";
...
// (Rendered by the inline approvals banner in QuickActions.)
export function CodeChangePreview({ payload }: { payload: Record<string, unknown> }) {
