...
export const OBJECT_TEMPLATES: ObjectTemplate[] = [
  { slug: "documents", label: "Document", label_plural: "Documents", icon: "FileText", color: "text-zinc-400", description: "Docs, tableurs & présentations produits par les agents." },
