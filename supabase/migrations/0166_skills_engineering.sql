-- 0166_skills_engineering.sql
-- AUTO-GENERATED by scripts/gen-skills-repo-migrations.mjs from skills_repo/.
-- Do not edit by hand — regenerate instead.
-- Software engineering skills (agent-skills pack): 24 system skills
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Api and Interface Design$S$, $S$api-and-interface-design$S$, $S$Guides stable API and interface design. Use when designing APIs, module boundaries, or any public interface. Use when creating REST or GraphQL endpoints, defining type contracts between modules, or establishing boundaries between frontend and backend.$S$, $S$engineering$S$, $S$Code2$S$, $S$# API and Interface Design
...
- [ ] API documentation or types are committed alongside the implementation$S$, '{"db_read","http_get","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Data"],"files":0}$S$::jsonb, true)
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Browser Testing With Devtools$S$, $S$browser-testing-with-devtools$S$, $S$Tests in real browsers via Chrome DevTools MCP. Use when building or debugging anything that runs in a browser. Use when you need to inspect the DOM, capture console errors, analyze network requests, profile performance, or verify visual output with real runtime data. Requires the chrome-devtools MCP server to be configured.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Browser Testing with DevTools
...
- [ ] JavaScript execution was limited to read-only state inspection$S$, '{"browse_web","web_fetch","db_read","http_get","security_scan","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Analysis","Research","Automation","Security","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Ci cd and Automation$S$, $S$ci-cd-and-automation$S$, $S$Automates CI/CD pipeline setup. Use when setting up or modifying build and deployment pipelines. Use when you need to automate quality gates, configure test runners in CI, or establish deployment strategies.$S$, $S$engineering$S$, $S$Code2$S$, $S$# CI/CD and Automation
...
- [ ] Pipeline runs in under 10 minutes for the test suite$S$, '{"browse_web","db_read","http_get","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Analysis","Automation","Security","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Code Review and Quality$S$, $S$code-review-and-quality$S$, $S$Conducts multi-axis code review. Use before merging any change. Use when reviewing code written by yourself, another agent, or a human. Use when you need to assess code quality across multiple dimensions before it enters the main branch.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Code Review and Quality
...
**Presumptive blockers:** surface and propose the simpler design for each of these; escalate to Required only when the change actively makes structure worse: a refactor that relocates complexity instead of reducing it; a change that pushes a file past the size boundary with no decomposition; feature logic added to a shared module; a near-duplicate of an existing canonical helper; a silent fallback that hides an unclear invariant.$S$, '{"browse_web","db_read","http_get","security_scan","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Automation","Security","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Code Simplification$S$, $S$code-simplification$S$, $S$Simplifies code for clarity. Use when refactoring code for clarity without changing behavior. Use when code works but is harder to read, maintain, or extend than it should be. Use when reviewing code that has accumulated unnecessary complexity.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Code Simplification
...
- [ ] A teammate or review agent would approve the change as a net improvement$S$, '{"http_get","security_scan","python_exec","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Code","Testing","Automation","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Context Engineering$S$, $S$context-engineering$S$, $S$Optimizes agent context setup. Use when starting a new session, when agent output quality degrades, when switching between tasks, or when you need to configure rules files and context for a project.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Context Engineering
...
- [ ] Context is refreshed when switching between major tasks$S$, '{"browse_web","web_search","db_read","http_get","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Research","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Debugging and Error Recovery$S$, $S$debugging-and-error-recovery$S$, $S$Guides systematic root-cause debugging. Use when tests fail, builds break, behavior doesn't match expectations, or you encounter any unexpected error. Use when you need a systematic approach to finding and fixing the root cause rather than guessing.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Debugging and Error Recovery
...
- [ ] Build succeeds
- [ ] The original bug scenario is verified end-to-end$S$, '{"browse_web","web_search","db_read","http_get","shell_exec","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Analysis","Security","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Deprecation and Migration$S$, $S$deprecation-and-migration$S$, $S$Manages deprecation and migration. Use when removing old systems, APIs, or features. Use when migrating users from one implementation to another. Use when deciding whether to maintain or sunset existing code.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Deprecation and Migration
...
- [ ] Deprecation notices are removed (they served their purpose)$S$, '{"http_get","security_scan","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Analysis","Automation","Security","Compliance"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Documentation and Adrs$S$, $S$documentation-and-adrs$S$, $S$Records decisions and documentation. Use when making architectural decisions, changing public APIs, shipping features, or when you need to record context that future engineers and agents will need to understand the codebase.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Documentation and ADRs
...
- [ ] Rules files (CLAUDE.md etc.) are current and accurate$S$, '{"browse_web","web_search","db_read","http_get","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Doubt Driven Development$S$, $S$doubt-driven-development$S$, $S$Subjects every non-trivial decision to a fresh-context adversarial review before it stands. Use when correctness matters more than speed, when working in unfamiliar code, when stakes are high (production, security-sensitive logic, irreversible operations), or any time a confident output would be cheaper to verify now than to debug later.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Doubt-Driven Development
...
- [ ] Any external CLI invocation was preceded by a PATH check, a working-binary test, syntax confirmation with the user, and explicit authorization to run$S$, '{"http_get","shell_exec","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Automation","Security","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Frontend ui Engineering$S$, $S$frontend-ui-engineering$S$, $S$Builds production-quality UIs. Use when building or modifying user-facing interfaces. Use when creating components, implementing layouts, managing state, or when the output needs to look and feel production-quality rather than AI-generated.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Frontend UI Engineering
...
- [ ] No accessibility warnings in dev tools or axe-core$S$, '{"browse_web","web_search","db_read","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Compliance","Cloud","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Git Workflow and Versioning$S$, $S$git-workflow-and-versioning$S$, $S$Structures git workflow practices. Use when making any code change. Use when committing, branching, resolving conflicts, or when you need to organize work across multiple parallel streams.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Git Workflow and Versioning
...
- [ ] `.gitignore` covers standard exclusions$S$, '{"web_search","db_read","http_get","shell_exec","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Code","Testing","Research","Automation","Compliance"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Idea Refine$S$, $S$idea-refine$S$, $S$Refines raw ideas into sharp, actionable concepts through structured divergent and convergent thinking. Use when an idea is still vague, when you need to stress-test assumptions before committing to a plan, or when you want to expand options before converging on one. Triggers on "ideate", "refine this idea", or "stress-test my plan".$S$, $S$engineering$S$, $S$Code2$S$, $S$# Idea Refine
...
- [ ] The user confirmed the final direction before any implementation work$S$, '{"security_scan","shell_exec","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Code","Testing"],"files":4}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
insert into public.agent_skill_files (skill_id, path, content, sort)
  select id, $S$scripts/idea-refine.sh$S$, $S$#!/bin/bash
set -e
...
$S$, 0 from public.agent_skills where workspace_id is null and slug = $S$idea-refine$S$
on conflict (skill_id, path) do update set content = excluded.content, updated_at = now();
insert into public.agent_skill_files (skill_id, path, content, sort)
  select id, $S$frameworks.md$S$, $S$# Ideation Frameworks Reference
...
$S$, 1 from public.agent_skills where workspace_id is null and slug = $S$idea-refine$S$
on conflict (skill_id, path) do update set content = excluded.content, updated_at = now();
insert into public.agent_skill_files (skill_id, path, content, sort)
  select id, $S$refinement-criteria.md$S$, $S$# Refinement & Evaluation Criteria
...
$S$, 2 from public.agent_skills where workspace_id is null and slug = $S$idea-refine$S$
on conflict (skill_id, path) do update set content = excluded.content, updated_at = now();
insert into public.agent_skill_files (skill_id, path, content, sort)
  select id, $S$examples.md$S$, $S$# Ideation Session Examples
...
$S$, 3 from public.agent_skills where workspace_id is null and slug = $S$idea-refine$S$
on conflict (skill_id, path) do update set content = excluded.content, updated_at = now();

insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Incremental Implementation$S$, $S$incremental-implementation$S$, $S$Delivers changes incrementally. Use when implementing any feature or change that touches more than one file. Use when you're about to write a large amount of code at once, or when a task feels too big to land in one step.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Incremental Implementation
...
- [ ] No uncommitted changes remain$S$, '{"db_read","http_get","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Automation","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Interview me$S$, $S$interview-me$S$, $S$Extracts what the user actually wants instead of what they think they should want. Achieves this through one-question-at-a-time interview until ~95% confidence about the underlying intent. Use when an ask is underspecified ("build me X" without "for whom" or "why now"), when the user explicitly invokes ("interview me", "grill me", "are we sure?", "stress-test my thinking"), or when you catch yourself silently filling in ambiguous requirements before any plan, spec, or code exists.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Interview Me
...
- [ ] Any handoff to a downstream skill (`idea-refine`, `spec-driven-development`) was framed in terms of the confirmed intent, not the original underspecified ask$S$, '{"web_search","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Analysis","Automation"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Observability and Instrumentation$S$, $S$observability-and-instrumentation$S$, $S$Instruments code so production behavior is visible and diagnosable. Use when adding logging, metrics, tracing, or alerting. Use when shipping any feature that runs in production and you need evidence it works. Use when production issues are reported but you can't tell what happened from the available data.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Observability and Instrumentation
...
For the at-a-glance version of this list, including the pre-launch instrumentation gate, see `references/observability-checklist.md`.$S$, '{"db_read","http_get","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Analysis","Research","Automation","Security","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Performance Optimization$S$, $S$performance-optimization$S$, $S$Optimizes application performance. Use when performance requirements exist, when you suspect performance regressions, or when Core Web Vitals or load times need improvement. Use when profiling reveals bottlenecks that need fixing.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Performance Optimization
...
- [ ] Existing tests still pass (optimization didn't break behavior)$S$, '{"browse_web","web_search","db_read","http_get","shell_exec","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Analysis","Research","Automation","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Planning and Task Breakdown$S$, $S$planning-and-task-breakdown$S$, $S$Breaks work into ordered tasks. Use when you have a spec or clear requirements and need to break work into implementable tasks. Use when a task feels too large to start, when you need to estimate scope, or when parallel work is possible.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Planning and Task Breakdown
...
- [ ] The human has reviewed and approved the plan$S$, '{"web_search","db_read","http_get","shell_exec","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Security and Hardening$S$, $S$security-and-hardening$S$, $S$Hardens code against vulnerabilities. Use when handling user input, authentication, data storage, or external integrations. Use when building any feature that accepts untrusted data, manages user sessions, or interacts with third-party services.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Security and Hardening
...
- [ ] LLM/model output validated and encoded before use (if AI features present)$S$, '{"browse_web","db_read","http_get","security_scan","shell_exec","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Automation","Security","Compliance","Cloud","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Shipping and Launch$S$, $S$shipping-and-launch$S$, $S$Prepares production launches. Use when preparing to deploy to production. Use when you need a pre-launch checklist, when setting up monitoring, when planning a staged rollout, or when you need a rollback strategy.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Shipping and Launch
...
- [ ] Logs are flowing
- [ ] Rollback tested or verified ready$S$, '{"browse_web","db_read","http_get","security_scan","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Code","Testing","Analysis","Research","Security","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Source Driven Development$S$, $S$source-driven-development$S$, $S$Grounds every implementation decision in official documentation. Use when you want authoritative, source-cited code free from outdated patterns. Use when building with any framework or library where correctness matters.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Source-Driven Development
...
- [ ] Anything that could not be verified is explicitly flagged as unverified$S$, '{"browse_web","web_search","http_get","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Automation","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Spec Driven Development$S$, $S$spec-driven-development$S$, $S$Creates specs before coding. Use when starting a new project, feature, or significant change and no specification exists yet. Use when requirements are unclear, ambiguous, or only exist as a vague idea.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Spec-Driven Development
...
- [ ] The spec is saved to a file in the repository$S$, '{"browse_web","db_read","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Analysis","Automation","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Test Driven Development$S$, $S$test-driven-development$S$, $S$Drives development with tests. Use when implementing any logic, fixing any bug, or changing any behavior. Use when you need to prove that code works, when a bug report arrives, or when you're about to modify existing functionality.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Test-Driven Development
...
**Note:** Run each test command after a change that could affect the result. After a clean run, don't repeat the same command unless the code has changed since — re-running on unchanged code adds no confidence.$S$, '{"browse_web","web_fetch","db_read","http_get","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Automation","Security","Compliance","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
...
insert into public.agent_skills (workspace_id, name, slug, description, category, icon, system_prompt_extension, required_tools, config, is_system) values
  (null, $S$Using Agent Skills$S$, $S$using-agent-skills$S$, $S$Discovers and invokes agent skills. Use when starting a session or when you need to discover which skill applies to the current task. This is the meta-skill that governs how all other skills are discovered and invoked.$S$, $S$engineering$S$, $S$Code2$S$, $S$# Using Agent Skills
...
| Ship | shipping-and-launch | Pre-launch checklist, monitoring, rollback plan |$S$, '{"browse_web","http_get","create_deliverable"}', $S${"source":"obra/agent-skills","pack":"engineering","domain":null,"subdomain":null,"tags":["Design","Code","Testing","Analysis","Automation","Security","Data"],"files":0}$S$::jsonb, true)
on conflict (slug) where workspace_id is null do update set
  name = excluded.name, description = excluded.description, category = excluded.category,
  icon = excluded.icon, system_prompt_extension = excluded.system_prompt_extension,
  required_tools = excluded.required_tools, config = excluded.config, is_system = true;
