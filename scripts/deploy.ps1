...
$encKey = if ($env:CREDENTIAL_ENCRYPTION_KEY) { $env:CREDENTIAL_ENCRYPTION_KEY } else { "ZBMi51O1Z/Itxpq0gRqqNBBwUZMspg4YuCDofErMwqQ=" }
supabase secrets set CREDENTIAL_ENCRYPTION_KEY=$encKey
